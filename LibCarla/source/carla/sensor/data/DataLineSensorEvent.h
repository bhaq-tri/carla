...
namespace data {
  ...
  class DataLineSensorEvent : public SensorData {
  public:

    using LaneMarking = road::element::LaneMarking;

    explicit DataLineSensorEvent(
        size_t frame,
        double timestamp,
  ...
  // class DataLineSensorEvent : public Array<rpc::ActorId> {
  // public:

  //   explicit DataLineSensorEvent(RawData &&data)
