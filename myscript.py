...
sensor_blueprints = [bp for bp in world.get_blueprint_library().filter('*other*')]
...
raceline = world.try_spawn_actor(sensor_blueprints[4], spawn_points[spawn_idx], vehicle)
